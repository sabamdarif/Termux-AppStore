...
if [[ "$selected_distro" == "ubuntu" ]] || [[ "$selected_distro" == "debian" ]]; then
    cd $working_dir
    download_file "https://github.com/shiftkey/desktop/releases/download/release-${version}/GitHubDesktop-linux-${archtype}-${version}.deb"
    ...
    cd $working_dir
    download_file "https://github.com/shiftkey/desktop/releases/download/release-${version}/GitHubDesktop-linux-${app_arch}-${version}.rpm"
